	...
	return (
		...
		>
			...
			<div class="rte">
				...
				MechkeyStore. Throughout the site, the terms “we”, “us” and “our” refer
				to MechkeyStore. MechkeyStore offers this website, including all
				...
				<br /> We have made every effort to display as accurately as possible
				...
				be accurate. <br /> We reserve the right, but are not obligated, to
				...
				services that we offer. All descriptions of products or product pricing
				are subject to change at anytime without notice, at the sole discretion
				of us. We reserve the right to discontinue any product at any time. Any
				offer for any product or service made on this site is void where
				prohibited. <br /> We do not warrant that the quality of any products,
				...
				transactions and contact you as needed. <br /> <br /> For more detail,
				please review our Returns Policy. <br /> <br />{" "}
				...
				use of optional third-party tools. <br /> Any use by you of optional
				...
				non-infringement. <br /> In no case shall MechkeyStore, our directors,
				...
				indemnify, defend and hold harmless MechkeyStore and our parent,
				...
				not limited to, any prior versions of the Terms of Service). <br /> Any
				...
				the Terms of Service should be sent to us at mechkey.store@gmail.com.
			</div>
		</Card>
	);
};
